...
const ScrollBlock_GPS = ({ searchBarStyle }) => {
  ...
  // 가상의 '핫플' 데이터 리스트
const hotplace = [
  { id: '1', title: '1. 핫플1', state: '상태1' },
  { id: '2', title: '2. 핫플2', state: '상태2' },
  { id: '3', title: '3. 핫플3', state: '상태3' },
  // ... 더 많은 항목 추가 가능
];

// 가상의 '한산' 데이터 리스트
const coldplace = [
  { id: '1', title: '1. 한산1', state: '상태1' },
  { id: '2', title: '2. 한산2', state: '상태2' },
  { id: '3', title: '3. 한산3', state: '상태3' },
  // ... 더 많은 항목 추가 가능
];
